...
проект magic_profile: создание и запись в базу данных натального и психоматричного профиля пользователя, расчет биоритмов.

hub: центр перенаправлений между проектов, центр взаимодействия с пользователем, точка взаимобействия с приложением (стек: юнити, си шарп)
